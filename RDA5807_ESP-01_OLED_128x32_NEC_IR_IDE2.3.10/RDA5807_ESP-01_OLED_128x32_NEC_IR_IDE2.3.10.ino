...
#include <Wire.h>
#include <radio.h> // USE Version 2.0
#include <RDA5807M.h> 
#include <RDSParser.h> 
#include <IRremote.h>
...
int channel = 1; // 1 //Start with a favorite station [0,1,2,3,4,..]
...
// Arduino 2.3.10
/*. Variables and constants in RAM (global, static), used 33148 / 80192 bytes (41%)
║   SEGMENT  BYTES    DESCRIPTION
╠══ DATA     1572     initialized variables
╠══ RODATA   3264     constants       
╚══ BSS      28312    zeroed variables
. Instruction RAM (IRAM_ATTR, ICACHE_RAM_ATTR), used 61027 / 65536 bytes (93%)
║   SEGMENT  BYTES    DESCRIPTION
╠══ ICACHE   32768    reserved space for flash instruction cache
╚══ IRAM     28259    code in IRAM    
. Code in flash (default, ICACHE_FLASH_ATTR), used 249092 / 1048576 bytes (23%)
║   SEGMENT  BYTES    DESCRIPTION
╚══ IROM     249092   code in flash  */